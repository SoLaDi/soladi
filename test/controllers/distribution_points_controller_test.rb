...
class DistributionPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update distribution_point" do
    patch distribution_point_url(@distribution_point), params: { distribution_point: { city: @distribution_point.city, housenumber: @distribution_point.housenumber, name: @distribution_point.name, street: @distribution_point.street, zipcode: @distribution_point.zipcode } }
